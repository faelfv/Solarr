...
public class ExcluirColab implements Command {
	@Override
	public void executar(HttpServletRequest request,
		...
		cs.excluir(colaborador.getIdcolab());
		@SuppressWarnings("unchecked")
		ArrayList<FuncaoColaborador> lista = (ArrayList<FuncaoColaborador>) session
				.getAttribute("lista");
		lista.remove(busca(colaborador, lista));
		session.setAttribute("lista", lista);
		view = request.getRequestDispatcher("ListarColaboradores.jsp");
